  ...
  return (
    <div className="bg-white rounded-lg shadow-sm border p-6">
        ...
        <div className="flex items-center gap-2">
          ...
          {response.confidence > 0.8 ? (
            ...
            <div 
              ...
              title="Medium confidence (60-80%)"
            ></div>
          ) : (
            <div 
              className="w-3 h-3 bg-red-500 rounded-full"
              aria-label="Low confidence"
              title="Low confidence (below 60%)"
            ></div>
          )}
        </div>
      </div>
      ...
      <div className="bg-gray-50 rounded p-4 mb-4 relative">
        ...
        <button
          onClick={handleCopy}
          className="absolute top-2 right-2 p-2 text-gray-500 hover:text-gray-700 hover:bg-gray-200 rounded transition-colors btn-focus"
      ...
      <div className="border-t pt-4">
        ...
        <div className="flex gap-3 mb-3">
          <button
            ...
            className={`px-3 py-2 rounded text-sm font-medium transition-colors btn-focus ${
              feedback === 'good'
          ...
          <button
            ...
            aria-pressed={feedback === 'needs-improvement'}
            aria-label="Rate response as needs improvement"
          >
            <span aria-hidden="true">👎</span> Needs Improvement
          </button>
        </div>
        ...
        {feedback && (
          <div className="space-y-3">
            ...
            <textarea
              ...
              rows={3}
              className="w-full px-3 py-2 border border-gray-300 rounded text-sm resize-vertical input-focus"
              aria-describedby="feedback-help"
            />
            <p id="feedback-help" className="sr-only">
              Provide additional details about your rating to help improve the AI responses.
            </p>
            
            <button
              onClick={handleFeedbackSubmit}
              className="px-4 py-2 bg-somerset-red text-white text-sm rounded hover:bg-red-700 transition-colors btn-focus"
              aria-describedby="feedback-submit-help"
            >
              Submit Feedback
            </button>
            <p id="feedback-submit-help" className="sr-only">
              Submit your feedback to help improve the AI response system.
            </p>
          </div>
        )}
      </div>
